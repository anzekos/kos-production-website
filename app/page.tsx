    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-10 right-10 w-60 h-60 bg-green-600/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-10 left-10 w-64 h-64 bg-yellow-600/10 rounded-full blur-3xl animate-pulse delay-1300"></div>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <InteractiveSocialButton href="#" hoverColor="hover:bg-purple-600">
                    <Instagram className="h-5 w-5" />
                  </InteractiveSocialButton>
                  <InteractiveSocialButton href="#" hoverColor="hover:bg-blue-600">
                    <Facebook className="h-5 w-5" />
                  </InteractiveSocialButton>
                  <InteractiveSocialButton href="#" hoverColor="hover:bg-red-600">
                    <Youtube className="h-5 w-5" />
                  </InteractiveSocialButton>
                  <InteractiveSocialButton href="#" hoverColor="hover:bg-blue-700">
